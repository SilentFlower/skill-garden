...
<!-- BEGIN skill-garden patch trellis-update-spec-native-autonomous-evaluation v0.6 -->
...
<!-- END skill-garden patch trellis-update-spec-native-autonomous-evaluation v0.6 -->
## Quality Checklist
