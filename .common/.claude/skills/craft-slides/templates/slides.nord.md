...
theme: nord               # Nord 风:冷色石板灰 + 柔和红蓝,沉稳护眼
colorSchema: dark         # Nord 以深色为主;改 light 切亮色
title: 演示标题            # 浏览器标签与导出文件名
info: |
  ## 演示标题
  一句话副标题 · 作者 · 场合
transition: slide-left    # 全局切页动画
layout: center            # Nord 不提供 cover 布局,封面用 center 居中(对齐 Nord 官方 example)
class: text-center        # 仅作用于首页:标题居中
